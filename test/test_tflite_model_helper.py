...
@pytest.fixture
def patch_tflite_model(monkeypatch):
    mock_tflite_model = MagicMock()
    monkeypatch.setattr("neo_loader.helpers.tflite_model_helper.Model", mock_tflite_model)
    return mock_tflite_model


def test_tflite_model_helper_float32(patch_tflite_model_helper, patch_tflite_model):
    test_tflite_model_helper = TFLiteModelHelper("test.tflite")
    sys.modules['tflite'] = Mock()
    sys.modules['tflite.Model'] = Mock()

    with patch("builtins.open", mock_open(read_data="data")) as mock_file:
        instance = patch_tflite_model.GetRootAsModel.return_value
...
def test_tflite_model_helper_unsupported_input_data_type(patch_tflite_model_helper, patch_tflite_model):
    test_tflite_model_helper = TFLiteModelHelper("test.tflite")
    sys.modules['tflite'] = Mock()
    sys.modules['tflite.Model'] = Mock()
...
def test_tflite_model_helper_wrong_user_input_names(patch_tflite_model_helper, patch_tflite_model):
    test_tflite_model_helper = TFLiteModelHelper("test.tflite")
    sys.modules['tflite'] = Mock()
    sys.modules['tflite.Model'] = Mock()
...
def test_tflite_model_helper_uint8(patch_tflite_model_helper, patch_tflite_model):
    test_tflite_model_helper = TFLiteModelHelper("test.tflite")
    sys.modules['tflite'] = Mock()
    sys.modules['tflite.Model'] = Mock()
